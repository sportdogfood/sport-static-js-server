    ...
    window.buttonMaster = function (status, caller) {
        ...
        if (status === 'logged in') {
            ...
            if (logoutButton) {
                ...
                console.error('logoutButton is not found in the DOM.');
            }
        } else if (status === 'logged out') {
            if (loginButton) {
                loginButton.style.display = 'inline';
                console.log('loginButton set to visible');
            } else {
                console.error('loginButton is not found in the DOM.');
            }

            if (logoutButton) {
                logoutButton.style.display = 'none';
                console.log('logoutButton set to hidden');
            } else {
                console.error('logoutButton is not found in the DOM.');
            }
        } else {
            console.error(`Invalid status: ${status} passed to buttonMaster`);
        }
    };
}
