...
function updateThisUserSession(updateObject) {
    // Retrieve the current session from localStorage or initialize it if it doesn't exist
...
// Merge the new key-value pair with the existing state
thisUserState = {
    ...thisUserState,
    [key]: value
};
...
// Attach `updateUserState` to `window` to make it globally accessible
